...
describe("Configuration loader", function()
  ...
  it("extracts flags, ports and listen ips from proxy_listen/admin_listen", function()
    ...
    assert.equal("0.0.0.0", conf.proxy_servers[1].listeners[1].ip)
    assert.equal(8000, conf.proxy_servers[1].listeners[1].port)
    assert.equal(false, conf.proxy_servers[1].listeners[1].ssl)
    assert.equal(false, conf.proxy_servers[1].listeners[1].http2)
    assert.equal("0.0.0.0:8000", conf.proxy_servers[1].listeners[1].listener)

    assert.equal("0.0.0.0", conf.proxy_servers[1].listeners[2].ip)
    assert.equal(8443, conf.proxy_servers[1].listeners[2].port)
    assert.equal(true, conf.proxy_servers[1].listeners[2].ssl)
    assert.equal(false, conf.proxy_servers[1].listeners[2].http2)
    assert.equal("0.0.0.0:8443 ssl", conf.proxy_servers[1].listeners[2].listener)

    assert.equal("127.0.0.1", conf.proxy_servers[2].listeners[1].ip)
    assert.equal(9000, conf.proxy_servers[2].listeners[1].port)
    assert.equal(true, conf.proxy_servers[2].mock)
    assert.equal(false, conf.proxy_servers[2].listeners[1].ssl)
    assert.equal(false, conf.proxy_servers[2].listeners[1].http2)
    assert.equal("127.0.0.1:9000", conf.proxy_servers[2].listeners[1].listener)

    assert.equal("127.0.0.1", conf.proxy_servers[2].listeners[2].ip)
    assert.equal(9443, conf.proxy_servers[2].listeners[2].port)
    assert.equal(true, conf.proxy_servers[2].mock)
    assert.equal(true, conf.proxy_servers[2].listeners[2].ssl)
    assert.equal(false, conf.proxy_servers[2].listeners[2].http2)
    assert.equal("127.0.0.1:9443 ssl", conf.proxy_servers[2].listeners[2].listener)
  ...
  it("extracts ssl flags properly when hostnames contain them", function()
    ...
    assert.equal("ssl.myname.com", conf.proxy_servers[1].listeners[1].ip)
    assert.equal(false, conf.proxy_servers[1].listeners[1].ssl)
    ...
    assert.equal("ssl_myname.com", conf.proxy_servers[1].listeners[1].ip)
    assert.equal(true, conf.proxy_servers[1].listeners[1].ssl)
  ...
  it("extracts 'off' from proxy_listen/admin_listen", function()
    ...
    assert.same({}, conf.proxy_servers)
    ...
    assert.same("offshore.com", conf.proxy_servers[1].listeners[1].ip)
